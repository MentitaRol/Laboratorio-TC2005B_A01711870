...
const canViewNombres = require('../util/canViewNombres');
...
// ruta dinamica
router.get('/:id', isAuth, canViewNombres, nombres_controller.get_lista);

router.get('/', isAuth, canViewNombres, nombres_controller.get_lista);
